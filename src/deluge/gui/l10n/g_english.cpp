...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_CHORD_BRUSH, "Chord Brush"},
        {STRING_FOR_COMMUNITY_FEATURE_KEYBOARD_NOTE_PREVIEW, "Keyboard Note Preview"},
        {STRING_FOR_COMMUNITY_FEATURE_QUANTIZE_DIVISION, "Quantize Division"},
        {STRING_FOR_COMMUNITY_FEATURE_REPAIR_SONG_DATES, "Repair Song Dates"},
        {STRING_FOR_COMMUNITY_FEATURE_RETROSPECTIVE_CAPTURE, "Retrospective MIDI Capture"},
        {STRING_FOR_KEYBOARD_LAYOUT_HARMONIC, "Harmonic"},
