...
// voicingWalk/voicingHome are BIAS-64 encoded on the wire (value + 64), because they are signed
// (-24..24) and everything else in the extras block is a raw 7-bit unsigned byte. voiceOctaves is a
